-- Seed: Karan <-> Eldridge Ribeiro crypto fund-transfer thread (16 messages)
-- Consolidated version with all later migrations baked in:
--   * Karan email = contact@affinitytrades.com (was afinitytrades72@gmail.com)
--   * Eldridge email = support@thekingdombank.com (was kingdomsupport87@gmail.com)
--   * Karan's display name = "Karan" (was "Karan Malani")
-- Run after schema.sql.
-- Idempotent: skips if the chain is already present.
...
BEGIN
  ...
  (e1, tid, NULL, 'Karan', 'contact@affinitytrades.com', karan_to, '[]'::jsonb,
   'Request for Assistance – Crypto Fund Transfer',
   $body$<p>Dear Eldridge,</p><p>I am reaching out regarding the transfer of <strong>5,243,902 USDT</strong> held with our <strong>Origin Custodian</strong>, which we intend to move to <strong>Destination Custodian</strong>.</p><p>Kindly guide us on the required documentation and process to initiate this transfer securely.</p><p>Best regards,<br>Karan</p>$body$,
   '2026-01-25T04:45:00Z');

  -- Email 2 — Eldridge, Jan 25 13:15 IST
  INSERT INTO emails (id, thread_id, parent_id, from_name, from_email, to_recipients, cc_recipients, subject, body, timestamp) VALUES
  (e2, tid, e1, 'Eldridge Ribeiro', 'support@thekingdombank.com', eldridge_to, '[]'::jsonb,
  ...
  INSERT INTO emails (id, thread_id, parent_id, from_name, from_email, to_recipients, cc_recipients, subject, body, timestamp) VALUES
  (e3, tid, e1, 'Karan', 'contact@affinitytrades.com', karan_to, '[]'::jsonb,
   'Follow-Up – Transfer Initiation',
   $body$<p>Dear Eldridge,</p><p>I hope you are doing well.</p><p>I wanted to follow up regarding the transfer initiation. Considering the time sensitivity of this transaction and the commitments associated with it, I would appreciate if you could confirm whether any documentation or approvals are pending from our side.</p><p>Your guidance will help us ensure there are no delays from our end.</p><p>Best regards,<br>Karan</p>$body$,
   '2026-01-28T05:35:00Z');

  -- Email 4 — Eldridge, Jan 30 14:30 IST
  INSERT INTO emails (id, thread_id, parent_id, from_name, from_email, to_recipients, cc_recipients, subject, body, timestamp) VALUES
  (e4, tid, e1, 'Eldridge Ribeiro', 'support@thekingdombank.com', eldridge_to, '[]'::jsonb,
